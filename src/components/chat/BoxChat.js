                        ...
                        <div className='box-chat'>
                            ...
                            <div className="content-box-chat">
                                <ListMessageStyle ref={messageListRef}>
                                    <Message nameUser="admin" avatar={avatarAdmin} time={Date.now.seconds} content="Chào mừng bạn đến với Star Cinema"></Message>
                                    <Message nameUser="admin" avatar={avatarAdmin} time={Date.now.seconds} content="Tôi có thể giúp gì cho bạn"></Message>
                                    {listMessage && listMessage.map((message, index) => (
                                        <Message key={index} nameUser={message.senderId} time={message.createAt?.seconds} content={message.content}></Message>
                                    ))}
                                </ListMessageStyle>
                                <SendMessageStyle>
